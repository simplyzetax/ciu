...
| --- | --- | --- | --- | --- |
| U1 | AT86RF233-ZU | Package_DFN_QFN:QFN-32-1EP_5x5mm_P0.5mm_EP3.35x3.35mm | AT86RF233-ZU | **UNVERIFIED**; datasheet-verifiable 2.4 GHz O-QPSK transceiver in the mandated QFN-32 package, with 17 mA typical TX current at 3.3 V. |
...
| Y1 | 16MHz | Crystal:Crystal_SMD_3225-4Pin_3.2x2.5mm | ABM8G-16.000MHZ-4Y-T3 | **UNVERIFIED**; datasheet-verifiable 16 MHz crystal compatible with the AT86RF233 clock requirement; no DC operating current. |
...
| AE1 | 2.4GHz | Antenna:Antennas_Chip_2.4GHz | 2450AT18A100E | **UNVERIFIED**; datasheet-verifiable 2.4 GHz chip antenna with reference layout; passive and zero quiescent current. |
| TP1 | TestPoint | Connector_PinHeader_1.00mm:PinHeader_1x01_P1.00mm_Vertical | 5015 | **UNVERIFIED**; datasheet-verifiable single-pin test point for MOSI; passive and zero quiescent current. |
| TP2 | TestPoint | Connector_PinHeader_1.00mm:PinHeader_1x01_P1.00mm_Vertical | 5015 | **UNVERIFIED**; datasheet-verifiable single-pin test point for MISO; passive and zero quiescent current. |
| TP3 | TestPoint | Connector_PinHeader_1.00mm:PinHeader_1x01_P1.00mm_Vertical | 5015 | **UNVERIFIED**; datasheet-verifiable single-pin test point for SCLK; passive and zero quiescent current. |
| TP4 | TestPoint | Connector_PinHeader_1.00mm:PinHeader_1x01_P1.00mm_Vertical | 5015 | **UNVERIFIED**; datasheet-verifiable single-pin test point for /SEL; passive and zero quiescent current. |
| TP5 | TestPoint | Connector_PinHeader_1.00mm:PinHeader_1x01_P1.00mm_Vertical | 5015 | **UNVERIFIED**; datasheet-verifiable single-pin RF-feed test point; passive and zero quiescent current. |
